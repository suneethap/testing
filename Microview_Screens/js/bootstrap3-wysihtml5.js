!function($, wysi) {
    ...
    var tpl = {
        ...
        "emphasis": function(locale, options) {
            ...
            return "<li>" +
                "<div class='btn-group'>" +
                "<a class='btn btn-" + size + " btn-default' data-wysihtml5-command='bold' title='CTRL+B' tabindex='-1'><span class='fa fa-bold fa-fw'></span></a>" +
				"</div>" +
				"<div class='btn-group'>" +
                "<a class='btn btn-" + size + " btn-default' data-wysihtml5-command='italic' title='CTRL+I' tabindex='-1'><span class='fa fa-italic fa-fw'></span></a>" +
				"</div>" +
				"<div class='btn-group'>" +
                "<a class='btn btn-" + size + " btn-default' data-wysihtml5-command='underline' title='CTRL+U' tabindex='-1'><span class='fa fa-underline fa-fw'></span></a>" +
                "</div>" +
                "</li>";
        },
		 ...
		 "justify": function(locale, options) {
            ...
            return "<li>" +
               "<div class='btn-group'>" +
			   "<a class='btn btn-" + size + " btn-default' data-wysihtml5-command='justifyLeft' title='" + locale.justify.left + "' tabindex='-1'><span class='fa fa-align-left fa-fw'></span></a>" +
			   "</div>" +
			   "<div class='btn-group'>" +
    		   "<a class='btn btn-" + size + " btn-default' data-wysihtml5-command='justifyCenter' title='" + locale.justify.center + "' tabindex='-1'><span class='fa fa-align-center fa-fw'></span></a>" +
			    "</div>" +
			   "<div class='btn-group'>" +
               "<a class='btn btn-" + size + " btn-default' data-wysihtml5-command='justifyRight' title='" + locale.justify.right + "' tabindex='-1'><span class='fa fa-align-right fa-fw'></span></a>" +
				"</div>" +
                "</li>";
        },
    ...
    var defaultOptions = $.fn.wysihtml5.defaultOptions = {
        ...
        parserRules: {
            classes: {
                // (path_to_project/css/wysiwyg5-color.css)
